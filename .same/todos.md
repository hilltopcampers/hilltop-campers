...
- [x] Added Google Ads conversion tracking tag (AW-17964436139) to root layout
- [x] Tag loads on all pages using Next.js Script component with afterInteractive strategy
- [x] Pushed changes to GitHub

## Recently Completed (Feb 19, 2026) - Google Ads Tag
- [x] Added Google Ads conversion tracking tag (AW-17964436139) to root layout
- [x] Tag loads on all pages using Next.js Script component with afterInteractive strategy
- [x] Pushed changes to GitHub
