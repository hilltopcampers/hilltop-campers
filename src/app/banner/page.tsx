  ...
  const renderBannerContent = () => {
    ...
    return (
      <>
        ...
        {/* Content */}
        <div className="relative z-10 h-full flex flex-col justify-between" style={{ padding: isFacebook ? "20px 32px" : isTwitter ? "24px 40px" : "20px 32px" }}>
          {/* Top - Logo */}
          <div className="flex items-center gap-3">
            <Image
              src="/images/hilltop-logo.png"
              alt="Hilltop Campers Logo"
              width={isFacebook ? 50 : isTwitter ? 56 : 48}
              height={isFacebook ? 50 : isTwitter ? 56 : 48}
              className="object-contain"
              unoptimized
            />
            <div>
              <h2 style={{ fontSize: isFacebook ? "22px" : isTwitter ? "24px" : "20px" }} className="font-bold">
                <span className="text-primary">HILLTOP</span>{" "}
                <span className="text-white">CAMPERS</span>
              </h2>
              <p style={{ fontSize: isFacebook ? "11px" : "12px" }} className="text-gray-300">Camper van conversion specialists</p>
            </div>
          </div>

          {/* Center - Main Text */}
          <div style={{ maxWidth: isFacebook ? "500px" : isTwitter ? "700px" : "450px" }}>
            <p className="text-primary font-semibold tracking-wider" style={{ fontSize: isFacebook ? "14px" : isTwitter ? "16px" : "14px", marginBottom: "4px" }}>
              {customText.tagline}
            </p>
            <h1 className="font-black text-white leading-tight" style={{ fontSize: isFacebook ? "32px" : isTwitter ? "42px" : "30px", marginBottom: "4px" }}>
              {customText.headline}
            </h1>
            <h2 className="font-black text-primary leading-tight" style={{ fontSize: isFacebook ? "28px" : isTwitter ? "38px" : "28px" }}>
              {customText.subheadline}
            </h2>
          </div>
          ...
          {/* Bottom - Contact */}
          {showContact && (
            <div className="flex items-center gap-6 text-white" style={{ fontSize: isFacebook ? "14px" : isTwitter ? "16px" : "14px" }}>
