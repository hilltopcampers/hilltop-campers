...
export const metadata = {
  title: "Built To Order Campervans | Hilltop Campers",
  description: "Create your dream campervan with our bespoke Built To Order Campers service in North Wales. Call today for a free quote!",
};
    ...
    <div className="pt-[104px]">
      ...
      <section id="new" className="py-20 bg-[#25272c] scroll-mt-32">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-primary text-xl font-bold mb-2">FROM £51,900</p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              <p className="text-primary text-xl font-bold mb-2">FROM £40,500</p>
              <h2 className="text-3xl md:text-4xl font-bold mb-6 uppercase">
      ...
      <section id="own" className="py-20 bg-[#25272c] scroll-mt-32">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-primary text-xl font-bold mb-2">FROM £19,500</p>
              <h2 className="text-3xl md:text-4xl font-bold mb-6 uppercase">
