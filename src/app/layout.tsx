...
export const metadata: Metadata = {
  title: {
    default: "Campervan Conversions | Renault Trafic Camper Conversion Company",
    template: "%s | Hilltop Campers",
  },
  description:
    "Hilltop Campers, the premier campervan conversion company in North Wales. We specialise in expert campervan conversions, focusing on bespoke Renault Trafic campervan models.",
  keywords: [
    // Primary Renault Trafic keywords
    ...
    "Trafic campervan",
    "Trafic camper conversion",
    "Trafic van conversion",
    "convert Renault Trafic to campervan",
    "Renault Trafic campervan for sale",
    "Trafic campervan for sale",
    "new Renault Trafic campervan",
    "Renault Trafic camper conversion UK",
    "Renault Trafic conversion specialists",
    "Renault Trafic pop top",
    "Renault Trafic pop top conversion",
    "Renault Trafic 4 berth",
    "Renault Trafic 4 berth campervan",
    "Renault Trafic SWB camper",
    "Renault Trafic SWB campervan",
    "Renault Trafic LWB camper",
    "Renault Trafic LWB campervan",
    "Renault Trafic Extra campervan",
    "Renault Trafic Sport campervan",
    "best Renault Trafic campervan",
    "professional Trafic conversion",
    "Renault Trafic campervan conversion cost",
    "Renault Trafic day van",
    "Renault Trafic weekend camper",
    // Location keywords
  ...
  openGraph: {
    title: "Campervan Conversions | Renault Trafic Camper Conversion Company",
    description:
      "Hilltop Campers, the premier campervan conversion company in North Wales. We specialise in expert campervan conversions, focusing on bespoke Renault Trafic campervan models.",
  ...
  "@graph": [
    {
      ...
      email: "hello@hilltopcampers.co.uk",
      logo: {
        "@type": "ImageObject",
  ...
  return (
    <html lang="en-GB">
      <head>
        ...
        <Script
          async
          src="https://www.googletagmanager.com/gtag/js?id=AW-17964436139"
