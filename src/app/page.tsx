...
import { Check, ArrowUpRight, Play, Battery, Flame, Zap, Shield } from "lucide-react";

// Featured campervan for sale
const featuredCampervan = {
  id: 1,
  title: "2025 Eryri Adventurer Renault Trafic Extra 4 Berth Campervan",
  description: "Brand New Hilltop Campers Conversion, Pop Top, Warranty, Finance Available",
  price: "56,995",
  status: "Available",
  image: "/images/camper_1.jpeg",
};
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Link href="/built-to-order#pre-owned" className="group">
              ...
              <div className="border-2 border-primary rounded-lg p-4 text-center group-hover:bg-primary/10 transition-colors">
                <p className="text-primary text-sm">FROM £42,500</p>
            ...
            <Link href="/built-to-order#new" className="group">
              ...
              <div className="border-2 border-primary bg-primary/10 rounded-lg p-4 text-center group-hover:bg-primary/20 transition-colors">
                <p className="text-primary text-sm">FROM £51.900</p>
                <p className="text-white font-bold uppercase">CONVERT A NEW VAN</p>
              </div>
            </Link>
            ...
            <div className="lg:col-span-2 bg-gradient-to-br from-[#1a1c20] to-[#2a2d32] rounded-lg overflow-hidden border border-primary/30">
              <div className="p-8">
                ...
                <p className="text-gray-300 text-sm mb-6 leading-relaxed">
                  ...
                  harness and controls supplied by industry-leading BCA Group. The Wallis Duo combined
                  Diesel Ceramic Hob and heater make this a completely gas-free vehicle without being
                  too hungry on off-grid power.
                </p>
