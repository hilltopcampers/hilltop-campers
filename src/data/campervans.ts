...
export const campervan1: Campervan = {
  ...
  shortDescription: "Brand New Van Brand new Hilltop Campers Conversion, Warranty, Finance Available. 0k Miles, 6 Speed Manual, Euro 6.",
  fullDescription: `This stunning 2025 Renault Trafic Extra Long Wheel Base has been fully converted by Hilltop Campers to our flagship Eryri Adventurer specification.
...
Perfect for couples or families looking for the ultimate adventure vehicle. The 4 berth configuration includes a comfortable rock and roll bed downstairs and an electric pop-top roof with a second double bed.

This vehicle is ready to drive away and start your adventures immediately.`,
  price: "56,995",
  status: "Available",
  mainImage: "/images/campervans/van-1/image-1.jpeg",
  gallery: [
    "/images/campervans/van-1/image-1.jpeg",
    "/images/campervans/van-1/image-2.jpeg",
    "/images/campervans/van-1/image-3.jpeg",
    "https://ugc.same-assets.com/3H6yAjNUKnXbI3OTkL2KBmmYmqvgeSTt.jpeg",
  ],
  specs: ["0k Miles", "6 Speed Manual", "Euro 6", "4 Berth"],
  features: [
    {
      category: "Living Area",
      items: [
        "Rock and Roll Bed - converts to comfortable seating",
        "Electric Pop-Top Roof with double bed",
        "LED ambient lighting throughout",
        "USB charging points",
        "240v hook-up capability",
...
Contact us now to discuss your customisation options and make this van truly yours.`,
  ...
  mainImage: "/images/campervans/van-2/image-1.svg",
  gallery: [
    "/images/campervans/van-2/image-1.svg",
    "/images/campervans/van-2/image-2.svg",
    "/images/campervans/van-2/image-3.svg",
    "/images/campervans/van-2/image-4.svg",
  ],
...
Available to personalise with your choice of interior colours and finishes. Contact us to discuss your requirements.`,
  price: "32,500",
  status: "Currently in Build",
  mainImage: "/images/campervans/van-3/image-1.svg",
  gallery: [
    "/images/campervans/van-3/image-1.svg",
    "/images/campervans/van-3/image-2.svg",
    "/images/campervans/van-3/image-3.svg",
    "/images/campervans/van-3/image-4.svg",
  ],
...
Ready to drive away and start your adventures today.`,
  price: "28,600",
  status: "Available",
  mainImage: "/images/campervans/van-4/image-1.svg",
  gallery: [
    "/images/campervans/van-4/image-1.svg",
    "/images/campervans/van-4/image-2.svg",
    "/images/campervans/van-4/image-3.svg",
    "/images/campervans/van-4/image-4.svg",
  ],
...
export const campervan5: Campervan = {
  id: 5,
  slug: "2024-renault-trafic-sport-lwb",
  title: "2024 Renault Trafic Sport LWB Campervan",
  shortDescription: "Currently being built to order. Pop Top, Full Hilltop Adventurer Spec.",
  fullDescription: `This 2024 Renault Trafic Sport Long Wheel Base was built to order with our full Hilltop Adventurer specification.

This vehicle has now been sold but we can build you something similar. Contact us to discuss your requirements.`,
  price: "",
  status: "Sold",
  mainImage: "/images/campervans/van-5/image-1.svg",
  gallery: [
    "/images/campervans/van-5/image-1.svg",
  ],
  specs: ["New Build", "6 Speed Manual", "Euro 6", "4 Berth"],
  features: [
    {
...
This vehicle has now been sold but we have similar vehicles available. Contact us to discuss your requirements.`,
  price: "",
  status: "Sold",
  mainImage: "/images/campervans/van-6/image-1.svg",
  gallery: [
    "/images/campervans/van-6/image-1.svg",
  ],
